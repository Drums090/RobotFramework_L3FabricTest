...
spines = { 'DCA-Spine1': {
                ...
                'underlay_neighbors': ['10.101.201.1', '10.101.202.1', '10.101.203.1', '10.101.204.1']
           ...
           'DCA-Spine2': {
                ...
                'ospf_neighbors': ['1.1.1.201', '1.1.1.202', '1.1.1.203', '1.1.1.204'],
                'evpn_peers': ['1.1.1.201', '1.1.1.202', '1.1.1.203', '1.1.1.204'],
                'underlay_neighbors': ['10.102.201.1', '10.102.202.1', '10.102.203.1', '10.102.204.1']
                         }
         }
...
leafs = {  'DCA-Leaf1': {
                ...
                'underlay_neighbors': ['10.101.201.0', '10.102.201.0', '192.168.255.255']
                         },
           'DCA-Leaf2': {
                ...
                'evpn_peers': ['1.1.1.101', '1.1.1.102'],
                'underlay_neighbors': ['10.101.202.0', '10.102.202.0', '192.168.255.255']
                         },
           'DCA-BL1': {
                ...
                'evpn_peers': ['1.1.1.101', '1.1.1.102'],
                'underlay_neighbors': ['10.101.204.0', '10.102.204.0', '192.168.255.255']
                         },
           'DCA-BL2': {
                ...
                'evpn_peers': ['1.1.1.101', '1.1.1.102'],
                'underlay_neighbors': ['10.101.204.0', '10.102.204.0', '192.168.255.254']
                         }
         }